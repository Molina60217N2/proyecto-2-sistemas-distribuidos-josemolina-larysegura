  ...
  <div class="flex flex-col items-center justify-center">
    ...
    <div class="grid grid-cols-3 mt-20 w-full mx-auto gap-10">
      <div class="max-w-sm rounded overflow-hidden shadow-lg" v-for="movie in movies" :key="movie.id">
        <RouterLink v-if="movie && movie.id" :to="'/movies/' + movie.id">
    ...
    <RouterLink to="/movies/create" class="mt-20 p-4 bg-green-700 text-slate-100 rounded-md mb-20">Crear un nuevo registro</RouterLink>
  </div>
</template>
<script>
